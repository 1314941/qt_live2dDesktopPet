 ...
 * that can be found at https://www.live2d.com/eula/live2d-open-software-license-agreement_en.html.
 ...
 这段C++代码定义了一个名为LAppDefine的命名空间，用于存储和定义在Live2D应用程序中使用的各种常量。
 这些常量包括视图比例、视图坐标、资源路径、模型路径、动作组、命中区域名称、动作优先级、调试日志设置
 以及渲染目标大小等。这些常量在应用程序的其他部分被引用，用于控制应用程序的行为和外观
...
namespace LAppDefine
{
    ...
    extern csmFloat32 ViewScale;              ///< 拡大縮小率
    ...
    extern void adjustViewScale(int newScale);
}
